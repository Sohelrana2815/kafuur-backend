...
const createArticle = async (payload) => {
    ...
    if (existingArticle) {
        throw new AppError(httpStatus.StatusCodes.CONFLICT, "An article with this URL slug already exists. Slugs must be completely unique.");
    }
